...
const Home: React.FC = () => {
  ...
  const lecturePicture = () => {
    ...
    axios({
      ...
      i.src = photo
      setTimeout(() => {
        context.setImgData([{ photo, width: i.width, height: i.height }])
  ...
  return (
    <IonPage
      style={{ backgroundColor: isRunningCamera ? 'transparent' : '#FFF' }}
    >
      {isRunningCamera ? (
        <>
          <IonFab
        ...
        <>
          ...
          >
            <IonFabButton
              ...
              onClick={lecturePicture}
            >
              <IonImg src="/assets/images/eye.jpg"></IonImg>
            </IonFabButton>
          </IonFab>
          <IonFab
            color="primary"
